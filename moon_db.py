...
from peewee import Model, DateField, TextField, PostgresqlDatabase, IntegerField, CharField, ModelSelect
...
class BaseModel(Model):
    ...
    def create_tables(self) -> None:
        tables_names = ['MoonData', 'MoonUser']
...
class MoonData(BaseModel):
    ...
    def get_moon_data(self): # -> dict:
        ...
        return {str(item.id): MoonItem(item.header, item.text) for item in today_info} 
